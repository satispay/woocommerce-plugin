...
class WC_Satispay extends WC_Payment_Gateway {
  ...
  public function init_form_fields() {
    $this->form_fields = array(
      ...
      'activationCode' => array(
        ...
        'type' => 'text',
        'description' => sprintf(__('Get a six characters Activation Code from Online Shop section on <a href="%s" target="_blank">Satispay Dashboard</a>.', 'woo-satispay'), 'https://dashboard.satispay.com/signup')
      ),
  ...
  public function admin_options() {
    try {
      ...
      echo '<div class="notice-error notice">';
      echo '<p>'.sprintf(__('Satispay is not correctly configured, get an Activation Code from Online Shop section on <a href="%s" target="_blank">Satispay Dashboard</a>', 'woo-satispay'), 'https://dashboard.satispay.com/signup').'</p>';
      echo '</div>';
    }
